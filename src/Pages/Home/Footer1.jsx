import { Box, Center, Divider, Flex, Image, Text, useBreakpointValue } from '@chakra-ui/react';
...
function TillMediumScreensFooter() {
  return (
    <Box
      pb="25px"
      color="white"
        ...
        <Flex flexWrap="wrap" justifyContent="space-evenly">
          <Box pl="10px">
            <Flex>
              ...
              <Text ml="7px" fontSize="sm">Become a Seller</Text>
            </Flex>
          </Box>
          <Box pl="10px">
            <Flex>
              ...
              <Text ml="7px" fontSize="sm">Advertise</Text>
            </Flex>
          </Box>
          <Box pl="10px">
            <Flex>
              ...
              <Text ml="7px" fontSize="sm">Gift Cards</Text>
            </Flex>
          </Box>
          <Box pl="10px">
            <Flex>
              ...
              <Text ml="7px" fontSize="sm">Help Center</Text>
            </Flex>
          </Box>
          <Box>
            <Text fontSize="sm">© 2007-2023 Flipkart.com</Text>
          </Box>
        </Flex>

        <Box mt="25px">
          <Center>
            <Image src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/payment-method_69e7ec.svg" alt="" />
          </Center>
        </Box>
      </Box>
    </Box>
...
function LargeAndAboveScreensFooter() {
  return (
    <Box
      pt="40px"
      pb="25px"
